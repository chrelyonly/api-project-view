...
const mysqlList = [
  {
    name: 'docker镜像源 公益节点 1',
    host: 'docker.542bsb.top',
    des: '直连镜像地址',
    case: "直接 docker pull docker.542bsb.top/nginx 或者 配置到镜像文件"
  },
  {
    name: 'docker镜像源 公益节点 2,走CF-CDN',
    host: 'docker1.542bsb.top',
    des: '直连镜像地址',
    case: "直接 docker pull docker1.542bsb2.top/nginx 或者 配置到镜像文件"
  },
  {
    name: 'docker镜像源 公益节点 3,走EDGE-CDN',
    host: 'docker.non-human-research-center.top',
    des: '直连镜像地址',
    case: "直接 docker pull docker.non-human-research-center.top/nginx 或者 配置到镜像文件"
  },
]
...
<template>
  <div class="page-container">
    ...
    <h1 class="title">🌟 docker镜像源 自用,不保证高可用 🌟</h1>
    <p class="subtitle">
      提供可公开访问的 docker镜像源 服务，适合开发、教学与测试场景 🌱
    </p>
    ...
    <div class="card-container">
      ...
      >
        ...
        <div class="card-content">
          ...
          <p><strong>描述：</strong>{{ item.des }}</p>
          <p><strong>案例：</strong>{{ item.case }}</p>
        </div>
      </el-card>
    </div>
